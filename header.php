...
<body <?php body_class(); ?>>
<div id="page" class="font-sans text-base text-gray-700 max-w-6xl mx-auto mt-8 lg:mt-20 px-4 lg:px-8">
	<div class="lg:flex">
		<header class="lg:pr-20 flex-1 flex lg:flex-col lg:items-end mb-8 md:mb-20">
			<div class="lg:mb-4 pr-4 md:pr-8 lg:pr-0">
				<a
			...
			<nav id="site-navigation" class="main-navigation lg:mb-8 text-right flex items-center">
				<?php
                wp_nav_menu(array(
		...
		<div id="content" class="site-content lg:w-3/4">
